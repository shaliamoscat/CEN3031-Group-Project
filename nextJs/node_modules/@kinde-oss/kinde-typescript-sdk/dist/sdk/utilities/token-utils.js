 ...
 */
export const commitTokenToMemory = async (sessionManager, token, type) => {
 ...
 * @param tokens
 */
export const commitTokensToMemory = async (sessionManager, tokens) => {
    await Promise.all([
 ...
 * @returns {string | null}
 */
export const getRefreshToken = async (sessionManager) => {
 ...
 * @returns {string | null}
 */
export const getAccessToken = async (sessionManager) => {
 ...
 * @returns {string | null}
 */
export const getUserFromMemory = async (sessionManager) => {
 ...
 * @param {UserType} user
 */
export const commitUserToMemory = async (sessionManager, user) => {
    await sessionManager.setSessionItem('user', user);
};
/**
