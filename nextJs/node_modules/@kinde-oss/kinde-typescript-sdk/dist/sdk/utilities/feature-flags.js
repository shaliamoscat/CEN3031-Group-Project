 ...
 * @returns {GetFlagType}
 */
export const getFlag = async (sessionManager, code, defaultValue, type) => {
    const featureFlags = (await getClaimValue(sessionManager, 'feature_flags')) ??
        {};
    ...
    if (flag?.t && type && type !== flag?.t) {
        throw new Error(`Flag ${code} is of type ${FlagDataType[flag.t]}, expected type is ${FlagDataType[type]}`);
    }
    const response = {
 ...
 */
export const getIntegerFlag = async (sessionManager, code, defaultValue) => {
 ...
 */
export const getStringFlag = async (sessionManager, code, defaultValue) => {
 ...
 */
export const getBooleanFlag = async (sessionManager, code, defaultValue) => {
