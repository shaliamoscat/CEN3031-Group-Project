...
const session_managers_1 = require("../../../sdk/session-managers");
describe('BrowserSessionManager', () => {
    const sessionManager = new session_managers_1.BrowserSessionManager();
    afterEach(async () => {
        await sessionManager.destroySession();
    });
    describe('new BrowserSessionManager()', () => {
        it('can construct BrowserSessionManager instance', () => {
            expect(() => new session_managers_1.BrowserSessionManager()).not.toThrowError();
        });
    });
    ...
    describe('setSessionItem()', () => {
        it('stores a value against the provided key in memory', async () => {
            ...
            expect(await sessionManager.getSessionItem(sessionItemKey)).toBe(sessionItemValue);
        });
    });
    ...
    describe('setBrowserSessionItem()', () => {
        it('stores a value against the provided key in the browser\'s session storage', async () => {
            ...
            expect(await sessionManager.getSessionItemBrowser(sessionItemKey)).toBe(sessionItemValue);
        });
    });
