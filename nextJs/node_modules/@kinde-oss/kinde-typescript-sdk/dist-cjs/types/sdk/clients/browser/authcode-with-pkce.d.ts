...
import type { CreateOrgURLOptions, RegisterURLOptions, LoginURLOptions, PKCEClientOptions } from '../types.js';
declare const createAuthCodeWithPKCEClient: (options: PKCEClientOptions) => {
